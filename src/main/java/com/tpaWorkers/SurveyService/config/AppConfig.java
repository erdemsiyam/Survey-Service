...
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setAnnotatedClasses(Survey.class, Respondent.class, Question.class, Answer.class, RespondentAnswer.class);
        //factoryBean.setPackagesToScan("com.tpaWorkers.SurveyService.dao.model"); // böyle de class lar alınır.
        return factoryBean;
    }
    @Bean
